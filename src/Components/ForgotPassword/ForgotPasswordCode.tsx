...
export default function ForgotPasswordCode() {
  ...
  return (
    ...
    >
      <h1 className="absolute text-white text-2xl font-main-font top-[39%] left-auto">
      ...
      <Button
        style="absolute top-[60%] right-auto text-sm uppercase py-4 px-14 rounded-full transition font-main-font duration-500 text-white bg-black hover:bg-33B249 hover:text-black"
