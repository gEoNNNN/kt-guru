...
export default function NewPassword() {
  return (
    ...
    >
      ...
      <Button style="absolute top-[65%] right-auto text-sm uppercase py-4 px-14 rounded-full transition font-main-font duration-500 text-white bg-black hover:bg-33B249 hover:text-black">
        Confirm
      </Button>
    </div>
  );
