  ...
  return (
    <div
      ...
      <form onSubmit={handleSubmit((data)=>setData(JSON.stringify(data)))}>
        ...
        />
        <Button
          style="absolute top-[65%] right-[38%] text-sm uppercase py-4 px-14 rounded-full transition font-main-font duration-500 text-white bg-black hover:bg-33B249 hover:text-black"
        >
          <input type="submit" />
          login
        </Button>
      ...
      <Button
        style="absolute top-[61%] right-[55%] font-main-font text-white"
        onClick={handleForgotPassword}
      >
        Forgot password?
      </Button>
      <Button
        style="absolute top-[61%] right-[38%] font-main-font text-white"
