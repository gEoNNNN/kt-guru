    ...
    <>
      ...
      <div>
        ...
        <div className="flex mt-[18%]">
          <h1 className="font-main-font text-2xl absolute mt-[-7%] w-1/2 flex justify-center">
            Ingredients
          </h1>
          ...
          <h1 className="font-main-font text-2xl absolute mt-[-7%] ml-[38%] w-1/2 flex justify-center">
            Instructions
          </h1>
          <div className="w-1/2 flex justify-center">
