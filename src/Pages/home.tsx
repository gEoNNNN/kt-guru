  ...
  return (
    ...
    <Navbar />
      <div className="h-screen flex justify-center items-center transform">
        ...
        <div className="absolute top-[38%] left-[50%] w-full text-left">
          <div className="fixed right-[-1%]">
            <img src={ready} className="w-[70%]"></img>
          </div>
        </div>
        <Button style="absolute top-[70%] right-[64%] text-xl uppercase py-6 px-16 rounded-full transition font-main-font duration-500 text-white bg-black hover:bg-33B249 hover:text-black" onClick={MainPage}>Lets Cook</Button>
      </div>
    </>
  );
}
